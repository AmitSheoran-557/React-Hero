...
const SwitchingEnergy = () => {
  return (
    <div className='max-w-[1140px] mx-auto w-full xl:mt-[169px] lg:mt-28 md:mt-20 sm:mt-14 mt-12 lg:px-3 px-4'>
      <div className='flex flex-wrap justify-center items-center'>
        ...
        <div className="lg:w-6/12 w-full max-lg:flex justify-center flex-col items-center max-lg:mt-5">
          <div className='max-lg:flex flex-col items-center'>
            ...
            <CustomBtnTwo btnTittle="Compare With Us" additionalClasses="xl:!max-w-[201px] max-w-max lg:!px-5 w-full xl:!mt-10 lg:!mt-7 !mt-5"/>
          </div>
        </div>
      </div>
    </div>
