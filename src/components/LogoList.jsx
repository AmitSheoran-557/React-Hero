  ...
  return (
    <div className='max-w-[1140px] lg:pt-[50px] pt-12 mx-auto  max-xl:px-4'>
      ...
      <div className='flex flex-wrap xl:gap-[51px] lg:gap-11 gap-8 justify-center'>
        ...
        <img className='lg:max-w-[126px] max-w-24 max-h-[62px]' src="./assets/image/png/dodo-logo.png" alt="logo-3" />
        <img className='lg:max-w-[126px] max-w-24 max-h-[62px]' src="./assets/image/png/origin-logo.png" alt="logo-4" />
        <img className='lg:max-w-[126px] max-w-24 max-h-[62px]' src="./assets/image/png/ovo-logo.png" alt="logo-5" />
        <img className='lg:max-w-[126px] max-w-24 max-h-[62px]' src="./assets/image/png/sumo-logo.png" alt="logo-6" />
        <img className='lg:max-w-[126px] max-w-24 lg:max-h-[62px] max-h-12'  src="./assets/image/png/agl-logo.png" alt="logo-7" />
      </div>
    </div>
  )
}
